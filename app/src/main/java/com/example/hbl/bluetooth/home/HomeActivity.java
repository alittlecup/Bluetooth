...
public class HomeActivity extends BaseActivity {
  ...
  @BindView(R.id.fab_back) FloatingActionButton floatingActionButton;
    ...
    LocationManager.getInstance(getApplication()).addObserver(location -> {
      ...
      RetrofitUtil.getService(RetrofitUtil.weatherClient)
          ...
          .enqueue(new WeatherCallback() {
            @Override public void onSucess(CityWeather cityWeather) {
      ...
      if (service.getUuid().toString().equals(SampleGattAttributes.BLUE_HOT_MEASUREMENT)) {
        for (BluetoothGattCharacteristic gattCharacteristic : service.getCharacteristics()) {
          if (gattCharacteristic.getUuid()
              .toString()
              .equals(SampleGattAttributes.CLIENT_CHARACTERISTIC_CONFIG)) {
  ...
  private void getFragments() {
    ...
    SingleOpFragment singleFragment = new SingleOpFragment();
    ...
    App.singleMatch = "hotup";
    App.singleDrawbleRes = R.drawable.hot_cup;
    App.singleName = "";
  }
  ...
  private void initHost() {
    ...
    bottomNavigationBar.addItem(
        new BottomNavigationItem(R.drawable.shop_active, "商城").setInactiveIconResource(
            R.drawable.shop_inactive))
        .addItem(new BottomNavigationItem(R.drawable.home_active, "首页").setInactiveIconResource(
            R.drawable.home_inactive))
        .addItem(new BottomNavigationItem(R.drawable.mine_active, "我的").setInactiveIconResource(
            R.drawable.mine_inactive))
        //                .addItem(new BottomNavigationItem(R.drawable.mine_on, "我的").setInactiveIconResource(R.drawable.mine_un))
        .setFirstSelectedPosition(1)
        .initialise();
    bottomNavigationBar.setTabSelectedListener(new BottomNavigationBar.OnTabSelectedListener() {
      @Override public void onTabSelected(int i) {
      ...
      @Override public void onTabUnselected(int i) {
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.hide(fragmentList.get(i));
        fragmentTransaction.commitAllowingStateLoss();
      }

      @Override public void onTabReselected(int i) {
      }
    });
    getSupportFragmentManager().beginTransaction()
        .replace(R.id.tabs, fragmentList.get(1))
  ...
  private void write2() {
    ...
    if (DONE2) {
      ...
      writeGattCharacteristic.setValue(
          ProcessData.StrToHexbyte(ProcessData.StringToNul(preOrder2)));
  ...
  private void getModeData() {
    RetrofitUtil.getService().getMode(App.tel).enqueue(new Callback<List<ModelData>>() {
      @Override
      ...
      @Override public void onFailure(Call<List<ModelData>> call, Throwable t) {
  ...
  @Override public void onBackPressed() {
    ...
    AlertDialog.Builder builder = new AlertDialog.Builder(this).setMessage("确认退出吗？")
