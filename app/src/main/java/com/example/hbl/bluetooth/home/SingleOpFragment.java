...
public class SingleOpFragment extends BaseFragment {
  @BindView(R.id.imBack) ImageView imBack;
  @BindView(R.id.cricle_seek_bar) CircleSeekBar cricleSeekBar;
  @BindView(R.id.upText) ImageView upText;//蓝牙状态开关，左侧
  @BindView(R.id.upCheck) ImageView upCheck;//蓝牙开关
  @BindView(R.id.clock) TextView clock;
  @BindView(R.id.upImageEn) ImageView upImageEn;//点量开关
  @BindView(R.id.time) TextView time;
  @BindView(R.id.image_min) ImageView imageMin;
  @BindView(R.id.sbTime) SeekBar sbTime;
  Unbinder unbinder;
  ...
  @Override protected void initView() {
    cricleSeekBar.setChangeListener(new CircleSeekBar.OnProgressChangeListener() {
      @Override public void onProgressChange(int duration, int progress) {

      }

      @Override public void onProgressChangeEnd(int duration, int progress) {
  ...
  private void initViewModelObserver() {
    ...
    mHomeViewModel.getmUpSwitch().observe(this, b -> {
      ...
      upCheck.setImageResource(
          b ? R.drawable.duble_bluetoooth_on : R.drawable.double_bluetootn_off);
    });
  ...
  @OnClick({ R.id.imBack, R.id.upText, R.id.upCheck }) public void onViewClicked(View view) {
    switch (view.getId()) {
      case R.id.imBack:
      ...
      case R.id.upCheck:
        ...
        mHomeViewModel.sendOrderUp(
            mHomeViewModel.getmUpSwitch().getValue() ? Order.WRITE_OPEN : Order.WRITE_CLOSE);
        break;
    }
  }
